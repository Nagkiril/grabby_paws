...
{
    public class ImagePixelPerUnitModule : VisualModule
    {
        ...
        private void Update()
        {
            ...
            _targetImage.pixelsPerUnitMultiplier = GetFrameFloat();
        ...
        private float GetFrameFloat()
        {
            var targetColor = Mathf.Lerp(_animationSet.Zero, _animationSet.One, _animationSet.Lerp.Evaluate(_animationProgress));
            return targetColor;
        }
